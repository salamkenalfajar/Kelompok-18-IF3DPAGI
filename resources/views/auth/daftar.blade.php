    ...
    <div class="h-screen bg-login w-screen flex justify-center items-center">
        <div class="bg-white w-7/12 h-[35rem] flex justify-center shadow-lg">
            ...
            <div class="flex flex-col justify-center -translate-x-64 gap-4">
                <label class="text-center text-3xl font-semibold text-color-coklat1 underline">Daftar</label>
                ...
                <form action="{{ route('daftar.post') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-wide bg-color-coklat1 text-white">Daftar</button>
                </form>
            </div>
