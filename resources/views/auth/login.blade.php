...
<body>
    <div class="h-screen bg-login w-screen flex justify-center items-center">
        <div class="bg-white w-7/12 h-[35rem] flex justify-center shadow-lg relative">
            ...
            <form method="POST" action="{{ route('login') }}" class="flex flex-col justify-center -translate-x-64 gap-4">
                @csrf
                ...
                <button type="submit" class="btn btn-wide bg-color-coklat1 text-white gap-4">Login</button>
            </form>
